...
public class ViewModel implements IViewModel {
    ...
    public void addCategory(String categoryName, String ownerCategoryName, EnumCategoryType currentCategoryTypeToInsert) {
        executorService.submit(() -> {
            ...
            if (isCategoryValid) {
                try {
                    model.insertNewCategory(categoryName, ownerCategoryName);
    ...
    public void deleteItem(String itemID) {
        executorService.submit(() -> {
            ...
            try {
                model.deleteItem(ViewModel.this.currentID, integerItemId);
    ...
    public void getPrimaryCategories(EnumConsumerOfCategories caller) {
        executorService.submit(() -> {
            try {
                ...
                view.showCategories(categories, EnumCategoryType.Primary, caller);
            } catch (CostManException e) {
                GUIUtils.showErrorMessageBox("Error", e.toString());
            }
        });
    ...
    public void getSubCategories(String currentSelectedPrimaryCategory, EnumConsumerOfCategories caller) {
        executorService.submit(() -> {
            try {
                List<String> categories = model.getSecondaryCategories(currentSelectedPrimaryCategory);
                view.showCategories(categories, EnumCategoryType.Secondary, caller);
            } catch (CostManException e) {
                GUIUtils.showErrorMessageBox("Error", e.toString());
            }
        });
